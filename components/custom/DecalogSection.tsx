...
const DecalogSection = () => {
  return (
    <SectionWrapper id="decalog" title="Decalogo">
      <ol
        type="a"
        className="list-outside list-[lower-alpha] ps-8 text-xl leading-relaxed text-gray-700 [&_li]:marker:text-[#57463F]"
      >
        {listItems.map((item) => (
...
const ListItem = ({ title, description }: { title: string; description: string }) => {
  return (
    <li className="text-xl text-gray-700 leading-relaxed not-first:mt-2">
